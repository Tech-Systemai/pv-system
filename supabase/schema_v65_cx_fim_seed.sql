...
'cx'
WHERE NOT EXISTS (SELECT 1 FROM public.fim_sops WHERE name = 'Disconnected or Missed Call' AND section = 'cx');
...
'cx'
WHERE NOT EXISTS (SELECT 1 FROM public.fim_sops WHERE name = 'Marking a Case Unreachable' AND section = 'cx');
