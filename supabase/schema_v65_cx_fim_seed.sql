...
-- Run once only. SOPs have no unique constraint - re-running creates duplicates.
...
('Veneer Fit and Look Assessment', 'Veneers',
...
(105, 'Impression / Technical',
 ...
 'none', NULL,
 (SELECT id FROM public.fim_sops WHERE name = 'ZOOM Impression Protocol')),
...
(106, 'Impression / Technical',
 ...
 'none', NULL,
 (SELECT id FROM public.fim_sops WHERE name = 'Disconnected or Missed Call')),
...
(107, 'Impression / Technical',
 ...
 (SELECT id FROM public.fim_sops WHERE name = 'Refund De-escalation')),
...
(108, 'Impression / Technical',
 ...
 'none', NULL,
 (SELECT id FROM public.fim_sops WHERE name = 'Fraud Concern Response')),
...
(401, 'Veneers Fit',
 ...
 (SELECT id FROM public.fim_sops WHERE name = 'Veneer Fit and Look Assessment')),
...
(801, 'Delivery',
 ...
 (SELECT id FROM public.fim_sops WHERE name = 'DNR Investigation')),
...
(901, 'Follow-Ups',
 ...
 'none', NULL,
 (SELECT id FROM public.fim_sops WHERE name = 'Existing Case Review')),
...
(903, 'Follow-Ups',
 ...
 'none', NULL,
 (SELECT id FROM public.fim_sops WHERE name = 'Marking a Case Unreachable')),
...
(904, 'Follow-Ups',
 ...
 (SELECT id FROM public.fim_sops WHERE name = 'Stopped Paying Follow-Up')),
...
(1102, 'New / Returning',
 ...
 'none', NULL,
 (SELECT id FROM public.fim_sops WHERE name = 'New Customer Onboarding')),
...
(1105, 'New / Returning',
 ...
 'none', NULL,
 (SELECT id FROM public.fim_sops WHERE name = 'Unclosed Sale Recovery'))
