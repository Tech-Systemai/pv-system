...
export const PERM_DEFAULTS: PermMatrix = {
  ...
  inbox:      { owner: 'both', admin: 'both',  supervisor: 'both',  accountant: 'both',  sales: 'agent', cx: 'agent' },
  attendance: { owner: 'both', admin: 'admin', supervisor: 'admin', accountant: 'none',  sales: 'agent', cx: 'agent' },
  monitoring: { owner: 'both', admin: 'admin', supervisor: 'admin', accountant: 'none',  sales: 'none',  cx: 'none'  },
  policy:     { owner: 'both', admin: 'admin', supervisor: 'none',  accountant: 'none',  sales: 'none',  cx: 'none'  },
