...
/* ── Client success plan board data ─────────────────────────────────────────── */
const CX_PLAN_ID = 'f0e1d2c3-b4a5-4678-9abc-def012345678';
const CX_PLAN_WIDGETS: Widget[] = [
  // Client lifecycle title
  { id: 'cx-t-01', type: 'text', x: 200, y: 20, w: 400, h: 65, content: 'Client Lifecycle', size: 'xl' },
  // Client journey note cards
  { id: 'cx-n-01', type: 'note', x: 60, y: 120, w: 270, h: 185,
    title: 'Contractor signs up',
    body: '* Success agent sends a welcoming text/call walking them through the onboarding cycle — no more, no less.' },
  { id: 'cx-n-02', type: 'note', x: 360, y: 120, w: 270, h: 185,
    title: 'Kickoff call booked',
    body: '* Agent confirms the kickoff slot in writing.\n* Book the technical onboarding session for the next stage.' },
  { id: 'cx-n-03', type: 'note', x: 660, y: 120, w: 270, h: 225,
    title: 'Account provisioning',
    body: '* Agent reminds them about the session 24 hours before through text/call.\n* Agent provisions the CRM workspace, phone numbers and user seats with the client on the call.\n* Agent follows up until the phone system is verified and live.' },
  { id: 'cx-n-04', type: 'note', x: 960, y: 120, w: 270, h: 210,
    title: 'Data & pipeline import',
    body: '* Agent imports existing customer lists and job history, then confirms the pipeline stages match how the contractor actually works.\n**** Make the client feel the momentum' },
  { id: 'cx-n-05', type: 'note', x: 1260, y: 120, w: 270, h: 175,
    title: 'AI agents configured',
    body: '* Agent turns on the outreach and booking agents, and reviews the first live conversations with the client' },
  { id: 'cx-n-06', type: 'note', x: 1560, y: 120, w: 270, h: 185,
    title: 'Go live & scale',
    body: '* Agent follows up and asks for referrals and reviews at this stage.\n*** Do not leave without a referral or review ****' },
  // Goal
  { id: 'cx-g-01', type: 'goal', x: 1880, y: 100, w: 290, h: 220,
    title: 'Client success targets',
    description: 'The goal of mapping the client lifecycle is to deliver organized, exceptional onboarding and support to every contractor we sign.',
  ...
  { id: 'cx-s-01', type: 'sticky', x: 60, y: 450, w: 210, h: 215, bg: '#fecdd3',
    text: 'TASK #1: The Full Calendar\n\nCall any client who just signed up and do not hang up until a kickoff call is locked into the calendar.' },
  { id: 'cx-s-02', type: 'sticky', x: 290, y: 450, w: 210, h: 215, bg: '#fecdd3',
    text: 'Task #2: The No-Show Recovery\n\nImmediately call any client who missed their onboarding call to reschedule them for the same day.' },
  { id: 'cx-s-03', type: 'sticky', x: 520, y: 450, w: 210, h: 215, bg: '#fecdd3',
    text: 'Task #3: The Setup Audit\n\nVerify call routing, pipeline stages and automations on the onboarding call before marking the account live.' },
  { id: 'cx-s-04', type: 'sticky', x: 60, y: 685, w: 210, h: 225, bg: '#fecdd3',
    text: 'Task #4: The Progress Update\n\nSend a "Your workspace is being configured by our team" update every 3 days while provisioning is in flight.' },
  { id: 'cx-s-05', type: 'sticky', x: 290, y: 685, w: 210, h: 225, bg: '#fecdd3',
    text: 'Task #5: The Integration Verification\n\nManually verify that every phone number and integration has passed its test call within 48 hours of the onboarding session.' },
  { id: 'cx-s-06', type: 'sticky', x: 520, y: 685, w: 210, h: 215, bg: '#fecdd3',
    text: 'Task #6: The CRM Cleanup\n\nEnsure every client has a "Next Step" date assigned so no one sits in a stage for more than 5 days.' },
  // ROUTINE section
  ...
  { id: 'cx-s-07', type: 'sticky', x: 60, y: 1010, w: 210, h: 215, bg: '#fef08a',
    text: 'Task #1: The Welcome Process\n\nSend the personalized "Welcome" SMS/Email to every new signup within 1 hour of purchase.' },
  { id: 'cx-s-08', type: 'sticky', x: 290, y: 1010, w: 210, h: 215, bg: '#fef08a',
    text: 'Task #2: The Account Update\n\n* Send login credentials and the onboarding checklist by email.\n* Log every provisioned number, seat and integration against the account in the CRM.' },
  { id: 'cx-s-09', type: 'sticky', x: 520, y: 1010, w: 210, h: 215, bg: '#fef08a',
    text: 'Task #3: The Go-Live Confirmation\n\nNotify the client via SMS/call the second their phone system and AI agents are confirmed live.' },
  { id: 'cx-s-10', type: 'sticky', x: 60, y: 1245, w: 210, h: 230, bg: '#bbf7d0',
    text: 'Task #4: The Churn Saver\n\nHandle "I want to cancel" emails/texts/calls by offering a "Senior Solutions Engineer" session to solve their setup issues instead of losing the account.' },
  { id: 'cx-s-11', type: 'sticky', x: 290, y: 1245, w: 210, h: 230, bg: '#bbf7d0',
    text: 'Task #5: The Review Extractor\n\nSecure a Google review from a client the moment they confirm the system is booking jobs, or after a successful call with them.' },
  { id: 'cx-s-12', type: 'sticky', x: 520, y: 1245, w: 210, h: 215, bg: '#bbf7d0',
    text: 'Task #6\n\n* Update the onboarding queue every day + brief the implementation team daily via email.' },
  { id: 'cx-s-13', type: 'sticky', x: 60, y: 1495, w: 210, h: 215, bg: '#bfdbfe',
    text: 'Task #7: The Referral Pitch\n\nOffer the "Friends & Family" $100 off to every client during the final follow-up call, plus a free month for the client themself.' },
  { id: 'cx-s-14', type: 'sticky', x: 290, y: 1495, w: 210, h: 215, bg: '#bfdbfe',
    text: 'Task #8: The Daily Recap\n\nSubmit the "3-Line Report" (Bookings, Onboardings, Rescues) before logging off.' },
  { id: 'cx-s-15', type: 'sticky', x: 520, y: 1495, w: 210, h: 225, bg: '#bfdbfe',
    text: 'Task #9: The Inbox Zero\n\n* Ensure all "How do I do X?" emails are answered by the end of the shift.\n* Ensure texts/calendars are ready for next day work.' },
  { id: 'cx-s-16', type: 'sticky', x: 60, y: 1740, w: 210, h: 240, bg: '#e9d5ff',
    text: 'Task #10: The Read & Sign Audit\n\n* Log into the portal every Monday to review the "Hall of Fame/Shame" onboarding calls.\n* Make sure all your training is completed before the past due.' },
  { id: 'cx-s-17', type: 'sticky', x: 290, y: 1740, w: 220, h: 275, bg: '#fed7aa',
    text: 'Task #11: ON FRIDAYS\n\n* Audit every client in the CRM who hasn\'t had a "Next Action" or note in the last 4 days\n* Call every client whose setup stalled this week and align them with the solution. (A senior solutions engineer will rebuild the configuration with them)\n* Identify and tag the Top 10 "Must FOLLOW-UP" clients for Monday morning.' },
];
...
export default function PlanningClient({ initialBoards, currentUserId }: { initialBoards: Board[]; currentUserId: string }) {
  ...
  useEffect(() => {
    ...
    const cxStarter: Board = {
      id: CX_PLAN_ID, title: 'Client Success Team Plan',
  ...
  useEffect(() => {
    const hasCxPlan = initialBoards.some(
      b => b.id === CX_PLAN_ID || b.title === 'Client Success Team Plan'
    );
    if (hasCxPlan) return;
    ...
    dbOp('planning_documents', 'insert', {
      ...
      if (!error) {
        setBoards(prev => {
          const already = prev.some(b => b.id === CX_PLAN_ID || b.title === 'Client Success Team Plan');
